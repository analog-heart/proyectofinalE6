...
public class ControladorImagen {
    ...
    @Autowired
    ServicioServicioOfrecido servicioServicio;
    ...
    public ResponseEntity<byte[]> imagenServicios(@PathVariable String id) {
        ServicioOfrecido servicio = servicioServicio.getOne(id);
